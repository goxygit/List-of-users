...
export const User = ({id, email, first_name, last_name, avatar, isInvited,onInvite }) => (
  <li>
    <div>
    ...
    <img onClick={()=> onInvite(id)} style={{width: '28px', height:'28px'}} src={isInvited? minus: plus} alt="Action" />
  </li>
);
